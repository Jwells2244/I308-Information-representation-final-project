...
<head>
    ...
    <title>Employees and transactions </title>
...
<body>
    ...
    <h3>Employee's with a work # and have handled a transaction where the customer's deposit was returned</h3>

    <form action="query5.php" method="post">
        <select name="form-eid">
            <?php
                $conn = mysqli_connect("db.luddy.indiana.edu", "i308f23_team34", "my+sql=i308f23_team34", "i308f23_team34");
                if (!$conn) { die("Connection failed: " . mysqli_connect_error());}
                $sql = "SELECT CONCAT(e.fName, ' ', e.lName) as name, e.id as id FROM emp as e order by name;";
